...
void AT_N5110LCD_init(AT_N5110_LCD_handle *instance)
{
	if (instance != NULL)
	{
		instance->frameBuffer = malloc(84*48);//(uint8_t*)0x30000000;
...
N5110_Status AT_N5110LCD_print_string(AT_N5110_LCD_handle* instance, sFONT *font, uint8_t *text, int32_t X, int32_t Y)
{
	if (X > N5110_WIDTH_PIXELS)
		return N5110_OUT_OF_FRAMEBUFFER_X;
	if (Y > N5110_HEIGHT_PIXELS)
